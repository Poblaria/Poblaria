...
export default function Home() {
  ...
  return (
    <div>
      <Box sx={{ position: "relative", height: { xs: "400px", md: "550px" }, width: "100%" }}>
        <Card sx={{ height: "100%", overflow: "hidden", position: "relative" }}>
          ...
          <Box sx={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0, 0, 0, 0.2)" }} />
          <Box
            sx={{
              position: "absolute",
              bottom: "20%",
      ...
      <Box sx={{ py: 8, bgcolor: "grey.100", textAlign: "center" }}>
        <Container>
          <Typography variant="h4" fontWeight="bold" sx={{ mb: 3, color: "grey.900" }}>
            {t("home.search.title")}
          </Typography>
        ...
        <Box className="container mx-auto px-4">
          <Box className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Box className="bg-white p-8 rounded-2xl shadow-lg border border-green-50">
              ...
              <Link href="/explore" className="font-medium hover:underline" style={{ color: "#5E7749" }}>
            ...
            <Box className="bg-white p-8 rounded-2xl shadow-lg border border-green-50">
              <Box className="bg-[#BECCB4] w-fit p-4 rounded-xl mb-4">
                <ContactSupportIcon className="h-8 w-8" style={{ color: "#5E7749" }} />
              </Box>
              <Typography variant="h5" fontWeight={700} mb={3}>
