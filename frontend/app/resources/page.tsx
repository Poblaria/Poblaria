      ...
      >
        <Card sx={{ height: "100%", overflow: "hidden", position: "relative" }}>
          ...
          >
            ...
            We’re here to help your family find a fresh start in the countryside —homes, jobs, schools, and financial aid, all in one place!—
            </Typography>
          ...
          <Box className="grid md:grid-cols-3 gap-8 mb-16">
            <Box className="bg-white p-8 rounded-2xl shadow-lg border border-green-50">
              ...
              <Typography variant="body1" color="text.secondary" mb={4}>
                Step-by-step help for moving, finding jobs, and settling into rural life
              </Typography>
              <Link
                href="/explore"
            ...
            <Box className="bg-white p-8 rounded-2xl shadow-lg border border-green-50">
              <Box className="bg-[#BECCB4] w-fit p-4 rounded-xl mb-4">
                <CurrencyDollarIcon className="h-8 w-8" style={{ color: "#5E7749" }} />
              </Box>
              <Typography variant="h5" fontWeight={700} mb={3}>
                Financial Support
              </Typography>
              <Typography variant="body1" color="text.secondary" mb={4}>
                Discover grants, tax benefits, and funding options for your move
              </Typography>
              <Link
                href="/explore"
                className="font-medium hover:underline"
