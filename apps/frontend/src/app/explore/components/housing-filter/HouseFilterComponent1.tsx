...
export default function Step1WhatLookingFor({
    ...
    const restorationOptions = [
        ...
        {
            value: "NEEDS_STRUCTURAL_RENOVATION",
            label: "Needs structural renovation"
        }
    ] as const;
    ...
    const openRentPopover = (e: React.MouseEvent<HTMLButtonElement>) =>
        setRentAnchor(e.currentTarget);
    const closeRentPopover = () => setRentAnchor(null);

    const openRestPopover = (e: React.MouseEvent<HTMLButtonElement>) =>
        setRestAnchor(e.currentTarget);
        ...
        >
            ...
            >
                ...
                <Chip
                    ...
                    onClick={() =>
                        setFilters((prev) => ({
                            ...prev,
                            purposeMain:
                                prev.purposeMain === "BUY" ? null : "BUY"
                        }))
                    }
                    variant={
                        filters.purposeMain === "BUY" ? "filled" : "outlined"
                    }
                    sx={{
                        borderRadius: "12px",
                        borderColor: "#D8D8D8",
                ...
                <Chip
                    ...
                    onClick={() =>
                        setFilters((prev) => {
                            const next =
                                prev.purposeMain === "RENT" ? null : "RENT";
                            return {
                                ...prev,
                                purposeMain: next,
                                ...(next !== "RENT" ? { rentSub: [] } : {})
                    ...
                    variant={
                        filters.purposeMain === "RENT" ? "filled" : "outlined"
                    }
                    sx={{
                        borderRadius: "12px",
                        borderColor: "#D8D8D8",
                ...
                <Chip
                    ...
                    onClick={() =>
                        setFilters((prev) => ({
                            ...prev,
                            purposeMain:
                                prev.purposeMain === "VOLUNTEER_STAY"
                                    ? null
                                    : "VOLUNTEER_STAY"
                        }))
                    }
                ...
                <Chip
                    ...
                    onClick={() =>
                        setFilters((prev) => {
                            const next =
                                prev.purposeMain === "RESTORATION_PROJECT"
                                    ? null
                                    : "RESTORATION_PROJECT";
                            return {
                                ...prev,
                                purposeMain: next,
                                ...(next !== "RESTORATION_PROJECT"
                                    ? { restorationSub: [] }
                                    : {})
                            };
                        })
            ...
            >
                <Box sx={{ p: 1, minWidth: 220 }}>
                    <Typography
                        sx={{ fontWeight: 800, fontSize: 13, px: 1, py: 0.5 }}
                    >
                        Rent options
                    </Typography>
                    <Divider />
                    {rentOptions.map((opt) => {
                        const checked = (filters.rentSub ?? []).includes(
                            opt.value
                        );
                        return (
                            <MenuItem
            ...
            >
                <Box sx={{ p: 1, minWidth: 280 }}>
                    ...
                    {restorationOptions.map((opt) => {
                        const checked = (filters.restorationSub ?? []).includes(
                            opt.value
                        );
                        return (
                            <MenuItem
                ...
                >
                    ...
                    <IconButton
                        ...
                        onClick={() =>
                            setFilters((p) => ({
                                ...p,
                                bedrooms: Math.min(20, p.bedrooms + 1)
                            }))
                        }
                    >
